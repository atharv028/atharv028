...
export function ThemeToggle() {
  ...
  return (
    <Button
      ...
      size="icon"
      onClick={toggleTheme}
      className="fixed top-4 right-4 sm:top-6 sm:right-6 z-50 bg-card/80 backdrop-blur-sm border-primary/20 hover:border-primary/40 transition-all duration-300 touch-target"
    >
